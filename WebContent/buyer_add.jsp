...
<%
	session.setAttribute("page", "buyer_add.jsp");
...
<html lang="en">
	...
	<body style="margin-top:0px">
			...
			<tr>
				<td>
					...
					<div class="panel-heading">
						<h3 class="panel-title" style="font-weight:bold">REGISTER NEW BUYER</h3>
					</div>
					...
					<table style="margin: 0 auto;font-family:Verdana">
						<tbody>
							<tr>
								<td align="right"><label class="label" style="font-size:12px;color:#555555">Name:</label></td><td><input type="text" class="form-control" id="trade_name" name="name" style="width:400px;height:30px;font-size:12px"></td>
							</tr>
							<tr>
					...
					<div style="width: 100%;text-align:center"><input type="button" value="REGISTER BUYER" id="action-button" class="btn btn-primary" style="width:180px"> <a href="item_buy.jsp?itemId=<%=itemId %>" class="btn btn-primary" style="width:180px">CANCEL</a></div>
		...
		<input type="hidden" name="action" value="buyer_add">
		</form>
	</body>
	...
	<script type="text/javascript">
		$("#action-button").click(function() {
			var returnValues = ["ok"];
			var redirectUrls = ["item_buy.jsp?itemId=<%=itemId%>&sellerId=<%=sellerId%>"];

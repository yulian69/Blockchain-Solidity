...
library LibSkinCareMarketplace {
    ...
    function getItems(MarketplaceData storage marketplaceData) internal view returns(bytes32[]) {
        return marketplaceData.sellers[marketplaceData.sellerAddresses[msg.sender]].items;
    }
